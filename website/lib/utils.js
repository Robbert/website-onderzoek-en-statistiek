        ...
        .map((item) =>
          item?.__typename && item.__typename !== 'ComponentSharedExternalLinks'
            ? {
                ...
                path: `/${CONTENT_TYPES[item.__typename.toLowerCase()].name}/${
                  item.slug
                }`,
                ...item,
              }
          ...
          if (item.type === 'textwithlinks') {
            return {
              ...
              links: Object.values(item)
                ...
                .flat()
                .map((link) =>
                  link.__typename !== 'ComponentSharedExternalLinks'
                    ? {
                        type: link.__typename.toLowerCase(),
                        name: CONTENT_TYPES[link.__typename.toLowerCase()].name,
                        path: `/${
                          CONTENT_TYPES[link.__typename.toLowerCase()].name
                        }/${link.slug}`,
                        ...link,
                      }
                    : {
